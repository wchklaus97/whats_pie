...
class CustomHugeListView<T> extends StatefulWidget {
  ...
  /// Size of the page. [CustomHugeListView] only keeps a few pages of items in memory any time.
  final int pageSize;
  ...
  /// The optional predefined LruMap to be used for cache, convenient for using LruMap outside CustomHugeListView.
...
class HugeListViewState<T> extends State<CustomHugeListView<T>> {
  ...
  @override
  void didUpdateWidget(CustomHugeListView<T> oldWidget) {
          ...
          child: DraggableScrollbar(
            ...
            child: ScrollablePositionedList.builder(
              ...
              itemScrollController:
                  widget.scrollController ?? widget.controller,
              ...
              itemBuilder: (context, index) {
                ...
                if (pageResult != null &&
                    pageResult.items.length > valueIndex) {
