                    ...
                    Padding(
                      padding: stateTick
                          ? const EdgeInsets.only(
                              left: 4, right: 20, top: 0, bottom: 2)
                          : const EdgeInsets.only(
                              left: 4, right: 4, top: 0, bottom: 2),
                      child: Text(
                        text,
                        style: textStyle,
                        textAlign: isPendingMsg
                            ? TextAlign.left
                            : isSender
                                ? TextAlign.right
                                : TextAlign.left,
